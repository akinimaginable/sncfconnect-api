...
val accounts: List<AccountEntity> = listOf(
    AccountEntity(firstName = "John", lastName = "Doe", email = "john.doe@example.org"),
    AccountEntity(firstName = "Jane", lastName = "Doe", email = "jane.doe@example.org")
)

val offers: List<OfferEntity> = listOf(
    OfferEntity(
